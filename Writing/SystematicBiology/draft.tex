...
\begin{figure}
\centering
   \includegraphics[width=0.9\textwidth]{Modif_matrix.eps}
...
\begin{figure}
\centering
   \includegraphics[width=0.9\textwidth]{RF_results_best.eps}
...
\begin{figure}
\centering
   \includegraphics[width=0.9\textwidth]{Tr_results_best.eps}
...
The character difference metric can be seen as the inverse of character correlation (see Methods): a high character difference approximates a low level of character correlation and vice versa.
...
This difference in both mechanisms could explain why, on average, Bayesian Inference seems better to recover the ``normal'' topology than maximum parsimony.b
