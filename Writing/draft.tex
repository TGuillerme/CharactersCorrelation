...
\begin{itemize}
    ...
    For example, in gnatosthomes, the apparition of the jaw in the gnatosthomes clade correlates with a whole sweep of characters present in modern gnatosthomes (e.g. beaks, tribosphenic molars, jaw protrusion, etc.). %TG: this links to inapplicable data!
...
\begin{figure}[!htbp]
\centering
   \includegraphics[width=0.9\textwidth]{Figures/RF_results_best.pdf} %TG: These figures will be cleaned up once I have the final results.
...
\begin{figure}[!htbp]
\centering
   \includegraphics[width=0.9\textwidth]{Figures/Tr_results_best.pdf} %TG: These figures will be cleaned up once I have the final results.
