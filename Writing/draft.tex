...
Because both $NTS_{RF}$ and $NTS_{Tr}$ metrics are bounded at $1$, the resulting in the residuals of any model based on the $NTS$ scores were not normal thus preventing the use of parametric tests for comparisons (see Supplementary @@@). %TG: TODO: residual normality + homscedasticity tests supp.
