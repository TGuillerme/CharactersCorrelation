...
%MB: I'm unsure what point this introduction serves. It somehow doesn't quite connect with what you say next. I think we can simply focus on the fact that the phenomenon hasn't been empirically explored. 
%MB: I think the point in this manuscript should be: OK, we believe two reasonable things: some characters will be expected to covary in a non-phylogenetic way, and that this phenomenon can reasonably be expected to mislead phylogenetic analysis. 
%MB: The question then becomes: how bad does it have to be to be a real effect?
%MB: Along with this are subquestions:
