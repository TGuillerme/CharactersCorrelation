...
\section{Characters replacement}

\begin{figure}[!htbp]
\centering
   \includegraphics[width=0.75\textwidth]{../Figures/Proportion_replaced_maxi.pdf}
\caption{Proportion of replaced characters in all the ``maximised'' matrices for 25, 75 and 150 taxa and 100, 350 and 1000 characters.}
\end{figure}

\begin{figure}[!htbp]
\centering
   \includegraphics[width=0.75\textwidth]{../Figures/Proportion_replaced_mini.pdf}
\caption{Proportion of replaced characters in all the ``minimised'' matrices for 25, 75 and 150 taxa and 100, 350 and 1000 characters.}
\end{figure}

\begin{figure}[!htbp]
\centering
   \includegraphics[width=0.75\textwidth]{../Figures/Proportion_replaced_rand.pdf}
\caption{Proportion of replaced characters in all the ``randomised'' matrices for 25, 75 and 150 taxa and 100, 350 and 1000 characters.}
\end{figure}


\input{../Tables/Tab_proportion_replacement.tex}
