...
\begin{figure}[!htbp]
\centering
   \includegraphics[width=0.75\textwidth]{../Figures/Zero_brlen_25t.pdf}
...
\begin{figure}[!htbp]
\centering
   \includegraphics[width=0.75\textwidth]{../Figures/Zero_brlen_75t.pdf}
...
\begin{figure}[!htbp]
\centering
   \includegraphics[width=0.75\textwidth]{../Figures/Zero_brlen_150t.pdf}
...
\input{../Tables/Tab_difference_change.tex}
...
\input{../Tables/Tab_proportion_duplicated.tex}
...
\newpage
\input{../Tables/Full_Tab_BCRFbest.tex}

\input{../Tables/Full_Tab_BCTrbest.tex}

\input{../Tables/Full_Tab_BCRFnull.tex}

\input{../Tables/Full_Tab_BCTrnull.tex}

\begin{landscape}
\input{../Tables/Full_Tab_Bayesian_WXRFbest.tex}
\end{landscape}

\begin{landscape}
\input{../Tables/Full_Tab_Parsimony_WXRFbest.tex}
\end{landscape}

\begin{landscape}
\input{../Tables/Full_Tab_Bayesian_WXTrbest.tex}
\end{landscape}

\begin{landscape}
\input{../Tables/Full_Tab_Parsimony_WXTrbest.tex}
\end{landscape}

\begin{landscape}
\input{../Tables/Full_Tab_Bayesian_WXRFnull.tex}
\end{landscape}

\begin{landscape}
\input{../Tables/Full_Tab_Parsimony_WXRFnull.tex}
\end{landscape}

\begin{landscape}
\input{../Tables/Full_Tab_Bayesian_WXTrnull.tex}
\end{landscape}

\begin{landscape}
\input{../Tables/Full_Tab_Parsimony_WXTrnull.tex}
\end{landscape}
