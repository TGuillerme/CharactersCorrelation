...
% @@@TODO-10: add ref to Sansom somewhere in the discussion.
...
% @@@TODO-11: specify this in the conclusion
...
We’ve added the comparisons between the trees from the modified matrices and the "starting tree" in the supplementary materials. %TG: is that done?
...
% @@@TODO-13 we have changed the font size for the figures/tables captions and the main text.
