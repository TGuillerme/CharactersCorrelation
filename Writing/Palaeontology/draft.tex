...
%@@@ TG: AP -> accuracy precision trade off.
...
These results suggest that ignoring the problem of character correlation or independence can often impact topology in phylogenetic analysis and that analysing the correlations between characters could help understanding problematic phylogenetic matrices.
...
\begin{itemize}
    \item \textbf{Character compatibility}: this is the result of how software actually interprets the differences between characters.
...
%@@@ AP: does it???  I dont think I agree!  basically this just over inflates the weight of the characters you picked at random. So if its a bad character-you will recover an incorrect tree with greater confidence. No?
