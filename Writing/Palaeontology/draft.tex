...
Overall, we found a negative effect of reducing character correlations on recovering the correct topology. %ap- will you confront the fact that this says that having character correlation is an advantage?
...
Furthermore, in bigger matrices (350 characters), there is a strong effect of the inference method with Bayesian trees being consistently less affected by character correlation than maximum parsimony trees. %ap but if cc increase recovering correct topology, then Bayesian is bad and we should use parsimony. Needs clarifying.
...
%AP it also kind of bothers me that you said there were 3 ways to have CC- but wait no, actually 4. But then below is 3 again... confusing
