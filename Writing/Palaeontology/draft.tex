...
but weaker and more ``spread-out'' correlations in molecular data \citep[][]{huelsenbeck1999effect}. %i.e. ``diffused'' correlations - though some regions of the genome may be thought as more correlated than others
...
Moreover, because phylogenetic inference software are unable to \textit{a priori} differentiate between these correlation types, it is important to understand to what extant topologies can be induced by such bias.
