...
Although we measured a significant difference between smaller and larger matrices (Tables \ref{Tab_pooledscharacters_test} and \ref{Tab_pooledstaxa_test}), %in terms of number of characters, between 100 and 1000 characters; 
