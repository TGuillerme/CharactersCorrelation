...
This way, a character \texttt{A = \{2,2,3,0,0,3\}} for six taxa would be standardised as \texttt{A' = \{1,1,2,3,3,2\}} (following the \textit{xyz} notation in \citealt{felsenstein2004inferring}; \hl{as used in} \citealt{Davalos01072014}).
