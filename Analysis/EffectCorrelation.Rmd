...
aov_data <- get.aov.data(whole_data, "RF", "best", combined = TRUE)
...
First let's test our model assumptions
...
Data is heterodastic for Triples norm + RF norm
Data is homoscedastic for Triples best + RF best
Data is non-normal for Triples norm + RF norm


The test assumptions are not validated.
We can instead use a non-parametric nested anova and a Bhattacharrya Coefficient (probability of overlap)

```{r}
##
run.bhatt.coeff(data, metric = "RF", best = "norm")
