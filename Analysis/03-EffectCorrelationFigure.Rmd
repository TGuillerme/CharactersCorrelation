...
plot.results.single(t25_list, metric = 2, what = "best",
    legend = TRUE, NTS = TRUE, xlab = "", ylab = "NTS(RF) for 25 taxa",
    axislab = FALSE)
plot.results.single(t75_list, metric = 2, what = "best", ylab = "NTS(RF) for 75 taxa",
    xlab = "", axislab = FALSE, NTS = TRUE)
plot.results.single(t150_list, metric = 2, what = "best",
    ylab = "NTS(RF) for 150 taxa", NTS = TRUE)
par(op)
```
...
op <- par(mfrow=c(3,1), mar = c(2, 4, 1, 2))
plot.results.single(t25_list, metric = 2, what = "best",
    legend = FALSE, NTS = TRUE, xlab = "", ylab = "NTS(RF) for 25 taxa",
    axislab = FALSE)
plot.results.single(t75_list, metric = 2, what = "best", ylab = "NTS(RF) for 75 taxa",
    xlab = "", axislab = FALSE, NTS = TRUE)
plot.results.single(t150_list, metric = 2, what = "best",
...
plot.results.single(t25_list, metric = 4, what = "best",
    legend = TRUE, NTS = TRUE, xlab = "", ylab = "NTS(Tr) for 25 taxa",
    axislab = FALSE)
plot.results.single(t75_list, metric = 4, what = "best", ylab = "NTS(Tr) for 75 taxa",
    xlab = "", axislab = FALSE, NTS = TRUE)
plot.results.single(t150_list, metric = 4, what = "best",
    ylab = "NTS(Tr) for 150 taxa", NTS = TRUE)
par(op)
```
...
op <- par(mfrow=c(3,1), mar = c(2, 4, 1, 2))
plot.results.single(t25_list, metric = 4, what = "best",
    legend = FALSE, NTS = TRUE, xlab = "", ylab = "NTS(Tr) for 25 taxa",
    axislab = FALSE)
plot.results.single(t75_list, metric = 4, what = "best", ylab = "NTS(Tr) for 75 taxa",
    xlab = "", axislab = FALSE, NTS = TRUE)
plot.results.single(t150_list, metric = 4, what = "best",
...
plot.results.single(t25_list, metric = 2, what = "null",
    legend = TRUE, NTS = TRUE, xlab = "", ylab = "NTS(RF) for 25 taxa",
    axislab = FALSE)
plot.results.single(t75_list, metric = 2, what = "null", ylab = "NTS(RF) for 75 taxa",
    xlab = "", axislab = FALSE, NTS = TRUE)
...
plot.results.single(t25_list, metric = 4, what = "null",
    legend = TRUE, NTS = TRUE, xlab = "", ylab = "NTS(Tr) for 25 taxa",
    axislab = FALSE)
plot.results.single(t75_list, metric = 4, what = "null", ylab = "NTS(Tr) for 75 taxa",
    xlab = "", axislab = FALSE, NTS = TRUE)
