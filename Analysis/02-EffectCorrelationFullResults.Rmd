...
make.xtable(sum_RF_null, caption = captions_summary[3], label = labels_summary[3], path = "../Writing/Tables/")
make.xtable(sum_Tr_null, caption = captions_summary[4], label = labels_summary[4], path = "../Writing/Tables/")
```
...
```{r, echo = FALSE, eval = FALSE}
## Labels
labels_wx <- paste0("Full_Tab_BC", rep(c("RF", "Tr"), 2), c(rep("best", 2), rep("null", 2)))
...
make.xtable(wx_RF_null, caption = captions_wx[3], label = labels_wx[3], path = "../Writing/Tables/")
make.xtable(wx_Tr_null, caption = captions_wx[4], label = labels_wx[4], path = "../Writing/Tables/")
```